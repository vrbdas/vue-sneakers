    ...
    <div class="container">
      <div class="header__wrapper">
        ...
        <div class="header__nav">
          <a class="header__nav-link header__nav-link-cart" @click="cartOpen = true">
            <CartIcon :color="cartIconColor" />
            <span v-if="catalogStore.cartPrice > 0" class="header__nav-link-cart-full"
              >{{ catalogStore.cartPrice }} ₽</span
            >
          ...
          <RouterLink class="header__nav-link" :to="{ name: 'favorite' }">
            <HeartIcon
              width="20"
              height="20"
              :fillColor="catalogStore.favoriteIds.length > 0 ? '#FF8585' : 'none'"
              :strokeColor="catalogStore.favoriteIds.length > 0 ? '#FF8585' : '#9B9B9B'"
            />
            Закладки
          </RouterLink>
